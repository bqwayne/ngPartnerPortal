...
export declare class VdlIconInvalidNameError extends VdlError {
 ...
 */
export declare class VdlIcon implements OnChanges, OnInit, AfterViewChecked {
    private _elementRef;
    private _renderer;
    private _vdlIconRegistry;
    private _color;
    ...
    constructor(_elementRef: ElementRef, _renderer: Renderer, _vdlIconRegistry: VdlIconRegistry);
...
export declare function ICON_REGISTRY_PROVIDER_FACTORY(parentRegistry: VdlIconRegistry, http: Http, sanitizer: DomSanitizer): VdlIconRegistry;
export declare const ICON_REGISTRY_PROVIDER: {
    provide: typeof VdlIconRegistry;
    deps: (Optional[] | typeof DomSanitizer | typeof Http)[];
    useFactory: (parentRegistry: VdlIconRegistry, http: Http, sanitizer: DomSanitizer) => VdlIconRegistry;
};
export declare class VdlIconModule {
    /** @deprecated */
