 ...
 * psuedo-prior state.
 */
export declare type VdlTabBodyPositionState = 'left' | 'center' | 'right' | 'left-origin-center' | 'right-origin-center';
/**
 ...
 */
export declare type VdlTabBodyOriginState = 'left' | 'right';
/**
 * Wrapper for the contents of a tab.
 */
export declare class VdlTabBody implements OnInit, AfterViewChecked, AfterContentChecked {
    private _dir;
    private _elementRef;
