 ...
 */
export declare class VdlProgressSpinnerCssMatStyler {
}
/**
 * Directive whose purpose is to add the vdl- CSS styling to this selector.
 */
export declare class VdlProgressCircleCssMatStyler {
}
/**
 * <vdl-progress-spinner> component.
 */
export declare class VdlProgressSpinner implements OnDestroy {
    private _ngZone;
    private _elementRef;
    private _renderer;
...
/**
 * <vdl-spinner> component.
 *
 * This is a component definition to be used as a convenience reference to create an
 * indeterminate <vdl-progress-spinner> instance.
 */
export declare class VdlSpinner extends VdlProgressSpinner implements OnDestroy {
    constructor(elementRef: ElementRef, ngZone: NgZone, renderer: Renderer);
    ngOnDestroy(): void;
}
export declare class VdlProgressSpinnerModule {
    /** @deprecated */
