...
export declare class VdlSelectChange {
    source: VdlSelect;
    value: any;
    constructor(source: VdlSelect, value: any);
}
export declare class VdlSelect implements AfterContentInit, ControlValueAccessor, OnDestroy {
    private _element;
    private _renderer;
    ...
    change: EventEmitter<VdlSelectChange>;
