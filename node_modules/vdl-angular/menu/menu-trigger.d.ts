 ...
 */
export declare class VdlMenuTrigger implements AfterViewInit, OnDestroy {
    private _overlay;
    private _element;
    ...
    /** @deprecated */
    _deprecatedVdlMenuTriggerFor: VdlMenuPanel;
    /** @deprecated */
    _deprecatedMatMenuTriggerFor: VdlMenuPanel;
    _vdlMenuTriggerFor: VdlMenuPanel;
