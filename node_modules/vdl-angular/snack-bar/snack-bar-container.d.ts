import { ComponentRef, AnimationTransitionEvent, NgZone, OnDestroy, Renderer, ElementRef } from '@angular/core';
 ...
 * @docs-private
 */
export declare class VdlSnackBarContainer extends BasePortalHost implements OnDestroy {
    private _ngZone;
    private _renderer;
    private _elementRef;
    ...
    snackBarConfig: VdlSnackBarConfig;
