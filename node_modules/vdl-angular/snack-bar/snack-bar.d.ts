 ...
 */
export declare class VdlSnackBar {
    private _overlay;
    private _live;
    ...
    _openedSnackBarRef: VdlSnackBarRef<any>;
    constructor(_overlay: Overlay, _live: LiveAnnouncer, _parentSnackBar: VdlSnackBar);
    /**
     ...
     */
    open(message: string, action?: string, config?: VdlSnackBarConfig): VdlSnackBarRef<SimpleSnackBar>;
    /**
