 ...
 */
export declare const VDL_SLIDER_VALUE_ACCESSOR: any;
/** A simple change event emitted by the VdlSlider component. */
export declare class VdlSliderChange {
    source: VdlSlider;
    value: number;
}
/**
 ...
 */
export declare class VdlSlider implements ControlValueAccessor {
    private _dir;
    ...
    change: EventEmitter<VdlSliderChange>;
    /** Event emitted when the slider thumb moves. */
    input: EventEmitter<VdlSliderChange>;
...
export declare class VdlSliderModule {
    /** @deprecated */
