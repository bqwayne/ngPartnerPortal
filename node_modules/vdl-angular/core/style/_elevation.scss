...
// }
//
// <div id="external-card" class="vdl-elevation-z2"><p>Some content</p></div>
//
...
$vdl-elevation-property: box-shadow !default;

// The default duration value for elevation transitions.
$vdl-elevation-transition-duration: 280ms !default;

// The default easing value for elevation transitions.
$vdl-elevation-transition-timing-function: $vdl-fast-out-slow-in-timing-function;

// Applies the correct css rules to an element to give it the elevation specified by $zValue.
// The $zValue must be between 0 and 24.
@mixin vdl-elevation($zValue) {
  ...
  #{$vdl-elevation-property}: #{map-get($_umbra-elevation-map, $zValue)},
...
//
// .foo {
//   transition: vdl-elevation-transition-property-value(), opacity 100ms ease;
//   will-change: $vdl-elevation-property, opacity;
// }
@function vdl-elevation-transition-property-value(
    $duration: $vdl-elevation-transition-duration,
    $easing: $vdl-elevation-transition-timing-function) {
  @return #{$vdl-elevation-property} #{$duration} #{$easing};
}
...
@mixin vdl-elevation-transition(
    $duration: $vdl-elevation-transition-duration,
    $easing: $vdl-elevation-transition-timing-function) {
  transition: vdl-elevation-transition-property-value($duration, $easing);
  will-change: $vdl-elevation-property;
}
